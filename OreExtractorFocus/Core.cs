...
{
    [BepInPlugin("Desperationfighter.TPC.OreExtractorFocus", "Ore Extractor Focus", "1.2.0.0")]
    public class BepInExPlugin : BaseUnityPlugin
    {
        ...
        private void Awake()
        {
            ...
            UseStage = Config.Bind("1_General", "UseStage", 2, "Set wanted usage Methode. 1 = Extract only Primary Ore and NEVER get any by Product; 2 = Focus on Primary ore. You still get a small amount of by product Ores");
